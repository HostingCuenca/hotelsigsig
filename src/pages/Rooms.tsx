...
// // //         description: "Nuestra suite más exclusiva con vistas panorámicas, ideal para una experiencia premium en Sígsig.",
// // //         amenities: [
// // //           { icon: <BedDouble className="w-5 h-5" />, text: "Cama King Size" },
// // //           { icon: <Coffee className="w-5 h-5" />, text: "Desayuno incluido" },
// // //           { icon: <Mountain className="w-5 h-5" />, text: "Vista panorámica" }
// // //         ]
// // //       },
// // //       {
// // //         title: "Habitación Deluxe",
// // //         price: "20",
// // //         image: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop",
// // //         description: "Espaciosa habitación con balcón privado y todas las comodidades para una estancia placentera.",
// // //         amenities: [
// // //           { icon: <BedDouble className="w-5 h-5" />, text: "Cama Queen Size" },
// // //           { icon: <Coffee className="w-5 h-5" />, text: "Desayuno incluido" },
// // //           { icon: <Users className="w-5 h-5" />, text: "Capacidad 2 personas" }
// // //         ]
// // //       },
// // //       {
...
// // //         price: "15",
// // //         image: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop",
// // //         description: "Confortable habitación con todas las comodidades esenciales para una excelente estancia.",
// // //         amenities: [
// // //           { icon: <BedDouble className="w-5 h-5" />, text: "Cama Matrimonial" },
// // //           { icon: <Coffee className="w-5 h-5" />, text: "Restaurantes Cerca" },
// // //           { icon: <Users className="w-5 h-5" />, text: "Capacidad 2 personas" }
// // //         ]
// // //       }
// // //     ];
...
// // //       { icon: <Tv />, text: "TV Cable" },
// // //       { icon: <ShowerHead />, text: "Agua Caliente" },
...
// // //           <h1 className="text-4xl font-['Playfair_Display'] text-[var(--color-wine-dark)] text-center mb-6">
...
// // //                   />
// // //                   <div className="absolute top-4 right-4 bg-[var(--color-gold)] text-white px-4 py-2 rounded-full font-semibold">
// // //                     ${room.price}/noche
// // //                   </div>
// // //                 </div>
// // //                 <div className="p-6">
...
// // //                         <span className="text-[var(--color-gold)] mr-2">{amenity.icon}</span>
...
// // //                   <a 
// // //                     href={`https://wa.me/593997930366?text=Hola,%20me%20interesa%20reservar%20${encodeURIComponent(room.title)}%20del%20Hotel%20Sígsig`}
// // //                     target="_blank"
...
// // //                     {amenity.icon}
// // //                   </div>
// // //                   <span className="text-gray-700 text-center">{amenity.text}</span>
// // //                 </div>
// // //               ))}
// // //             </div>
// // //           </div>
...
// //     { icon: <Tv className="w-6 h-6" />, text: "Smart TV con Netflix" },
// //     { icon: <ShowerHead className="w-6 h-6" />, text: "Agua Caliente 24/7" },
// //     { icon: <Clock className="w-6 h-6" />, text: "Servicio a la Habitación" },
// //     { icon: <Coffee className="w-6 h-6" />, text: "Desayuno Continental" },
// //     { icon: <MapPin className="w-6 h-6" />, text: "Ubicación Céntrica" }
// //   ];
...
// //                   {amenity.icon}
// //                 </div>
// //                 <span className="text-gray-700 text-center text-sm">{amenity.text}</span>
// //               </div>
// //             ))}
// //           </div>
// //         </div>
...
// //               <div>
// //                 <label className="block text-gray-700 mb-2">Habitación</label>
// //                 <select 
// //                   value={selectedRoom}
// //                   onChange={(e) => setSelectedRoom(e.target.value)}
// //                   className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-[var(--color-gold)]"
// //                 >
// //                   <option value="">Seleccionar...</option>
// //                   <option value="suite">Suite ($35)</option>
// //                   <option value="deluxe">Deluxe ($20)</option>
// //                   <option value="standard">Estándar ($15)</option>
// //                 </select>
// //               </div>
// //               <div>
...
// //               </div>
// //               <div>
// //                 <label className="block text-gray-700 mb-2">Huéspedes</label>
// //                 <select 
// //                   value={guests}
...
// //               }}
// //               className="metallic-gold text-white px-8 py-4 rounded-full flex items-center justify-center mt-8 mx-auto"
// //             >
...
// //                 price: "20",
// //                 image: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop",
// //                 description: "Espaciosa habitación con balcón privado.",
// //                 features: [
// //                   "Cama Queen Size",
// //                   "Balcón privado",
...
// //                 price: "15",
// //                 image: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop",
// //                 description: "Confortable habitación con comodidades esenciales.",
// //                 features: [
// //                   "Cama Matrimonial",
// //                   "Baño privado",
// //                   "Smart TV 32\"",
...
// //                         <CheckCircle className="w-4 h-4 text-[var(--color-gold)] mr-2" />
// //                         {feature}
// //                       </li>
// //                     ))}
// //                   </ul>
...
// //                 description: "A solo 1 cuadra del Terminal Terrestre y cerca del centro histórico."
// //               },
// //               {
// //                 icon: <Star className="w-8 h-8" />,
// //                 title: "Calidad Garantizada",
// //                 description: "Habitaciones impecables y servicio personalizado."
// //               },
// //               {
// //                 icon: <Bus className="w-8 h-8" />,
// //                 title: "Fácil Acceso",
// //                 description: "Transporte público y taxis disponibles 24/7."
// //               },
// //               {
// //                 icon: <Users className="w-8 h-8" />,
// //                 title: "Atención 24/7",
// //                 description: "Personal capacitado disponible todo el día."
// //               }
// //             ].map((feature, index) => (
...
// //       {/* CTA Final */}
// //       <section className="py-16 bg-[var(--color-wine-dark)] text-white">
...
// //             Disfrute de la mejor hospitalidad en Sígsig. Contáctenos para tarifas especiales 
// //             en estadías prolongadas y grupos.
// //           </p>
// //           <div className="flex justify-center gap-4">
// //             <button className="metallic-gold text-white px-8 py-4 rounded-full flex items-center">
...
// //               Llamar Ahora <ChevronRight className="ml-2" />
// //             </button>
// //           </div>
// //         </div>
// //       </section>
...
//         "https://res.cloudinary.com/dzfakhjlh/image/upload/v1740704242/hotelsigsig/rynblqkpenlripa3mtdx.jpg"
//       ],
...
//         "https://res.cloudinary.com/dzfakhjlh/image/upload/v1740704242/hotelsigsig/z106xypglndckyljdkqb.jpg"
//       ],
//       description: "Nuestra opción más amplia, ideal para familias o grupos. Con capacidad hasta para 4 personas, ofrece el máximo confort y espacio para todos los huéspedes.",
//       features: [
...
//     { icon: <Coffee className="w-6 h-6" />, text: "Desayuno Continental" },
//     { icon: <Clock className="w-6 h-6" />, text: "Servicio a la Habitación" },
//     { icon: <Utensils className="w-6 h-6" />, text: "Restaurante en el Hotel" },
...
//                     {/* Indicadores de capacidad y tamaño */}
...
//                     {/* Precio */}
//                     <div className="absolute top-4 right-4 bg-[var(--color-gold)] text-white px-4 py-2 rounded-lg font-medium">
//                       ${room.price}/noche
//                     </div>
...
//                     <a 
//                       href={`https://wa.me/593997930366?text=Hola,%20me%20interesa%20información%20sobre%20la%20${room.title}%20a%20$${room.price}/noche`}
//                       target="_blank"
//                       rel="noopener noreferrer"
...
//                       <p>• Los precios son por noche e incluyen el desayuno.</p>
//                       <p>• Para confirmar su reserva, se requiere el pago del 50% por adelantado.</p>
//                       <p>• Cancelación gratuita hasta 3 días antes de la llegada.</p>
//                       <p>• Niños menores de 5 años se hospedan gratis compartiendo cama.</p>
...
//                 description: "Disfrute de tranquilidad total con nuestro servicio de recepción y vigilancia las 24 horas."
//               },
//               {
//                 icon: <Users className="w-8 h-8" />,
...
//                 "Las habitaciones son muy amplias y cómodas. La ubicación es perfecta, a pocos pasos del terminal. El personal es amable y servicial. Sin duda regresaremos."
//               </p>
...
//                   <span className="text-xs text-gray-500">Habitación Matrimonial</span>
//                 </div>
//               </div>
//             </div>
...
//               <p className="text-gray-700 text-sm italic mb-4">
//                 "La habitación triple era muy espaciosa, perfecta para nuestra familia. Disfrutamos mucho del desayuno tradicional. Todo muy limpio y el servicio excelente."
//               </p>
...
//                 </div>
//                 <div className="flex flex-col">
//                   <span className="text-sm font-medium text-[var(--color-wine-dark)]">Marcela F.</span>
//                   <span className="text-xs text-gray-500">Habitación Triple</span>
//                 </div>
//               </div>
//             </div>
...
//               <p className="text-gray-700 text-sm italic mb-4">
//                 "Para un viajero solitario, la habitación sencilla fue perfecta. Buena relación calidad-precio, limpia y con todo lo necesario. El personal siempre atento."
//               </p>
...
//                 </div>
//                 <div className="flex flex-col">
//                   <span className="text-sm font-medium text-[var(--color-wine-dark)]">Juan P.</span>
//                   <span className="text-xs text-gray-500">Habitación Sencilla</span>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                 answer: "Sí, todas nuestras tarifas incluyen desayuno continental servido en nuestro comedor de 7:00 a 10:00 am. Ofrecemos opciones tradicionales ecuatorianas y continentales."
//               },
//               {
...
//                 answer: "Sí, nuestras habitaciones dobles y triples son ideales para familias. Los niños menores de 5 años se hospedan gratis compartiendo cama con los padres."
//               }
//             ].map((item, index) => (
...
//               className="border-2 border-[var(--color-gold)] text-[var(--color-gold)] px-8 py-4 rounded-full flex items-center hover:bg-[var(--color-gold)] hover:text-white transition-colors"
//             >
